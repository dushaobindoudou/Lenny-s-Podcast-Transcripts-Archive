# Robby Stein - Lenny's Podcast Insights
## Robby Stein - Lenny's播客洞见

---

## About the Guest | 关于嘉宾

**Robby Stein** joined Lenny for an in-depth conversation on product management, leadership, and building successful products.

**Robby Stein** 与Lenny进行了深入对话，讨论产品管理、领导力和打造成功产品的经验。
...
**You've built a lot of very successful products. You used this phrase**:
...
**Okay, perfect. We'll talk about some of that. I asked you as we were getting ready for this conversation, what's one thing you wanted to get across in this conversation? What's something you think would be really helpful for product builders to hear to help them build more successful products? And you used this phrase**:

embodying relentless improvement. Can you just talk about that? What does that mean? Why is this so important?
Robby Stein :
