# Ivan Zhao - Lenny's Podcast Insights
## Ivan Zhao - Lenny's播客洞见

---

## About the Guest | 关于嘉宾

**Ivan Zhao** joined Lenny for an in-depth conversation on product management, leadership, and building successful products.

**Ivan Zhao** 与Lenny进行了深入对话，讨论产品管理、领导力和打造成功产品的经验。
...
**I saw a stat you're coding 18 hours a day. Here's the quote I heard,**:

We just code, code, code. Then hey, let's go for food. Then we go eat, go back to work, and do it again."
Ivan Zhao :
