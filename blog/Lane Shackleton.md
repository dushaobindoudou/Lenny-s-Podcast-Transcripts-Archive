# Lane Shackleton - Lenny's Podcast Insights
## Lane Shackleton - Lenny's播客洞见

---

## About the Guest | 关于嘉宾

**Lane Shackleton** joined Lenny for an in-depth conversation on product management, leadership, and building successful products.

**Lane Shackleton** 与Lenny进行了深入对话，讨论产品管理、领导力和打造成功产品的经验。
...
**They feel this the most because they're the ones that are driving decisions and really the ones that are driving discussions oftentimes in companies. And so I think the problem with one-way writeups I felt very deeply at Google and YouTube. And just to name them, the first one is you would always be trying to figure out who's read your write-up. So I have many memories of sending a write-up out at 11**:

30 PM and then waiting patiently for the avatar of the SVP in my area to show up in there. And that was a sign that they had read it, which is just totally insane if you think about that behavior. The second one is you end up having a lot of the discussion in the comments itself. So this is a space that's really built for grammar and spell checking and things like that. And you're having these really meaningful discussions in this a hundred pixel right margin.
:
