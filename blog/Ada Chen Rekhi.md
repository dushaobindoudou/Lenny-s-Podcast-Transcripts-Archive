# Ada Chen Rekhi - Lenny's Podcast Insights
## Ada Chen Rekhi - Lenny's播客洞见

---

## About the Guest | 关于嘉宾

**Ada Chen Rekhi** joined Lenny for an in-depth conversation on product management, leadership, and building successful products.

**Ada Chen Rekhi** 与Lenny进行了深入对话，讨论产品管理、领导力和打造成功产品的经验。

---

## Key Takeaways | 核心要点

### And then I'm getting [inaudible 00
...
Lenny :
So the core lesson here is just, versus just emailing a bunch o...

### Does anyone ever get multiple executive coaches that... I like how we went from, you don't need a coach to maybe need a month [inaudible 00
...
10:58] for so long. Yeah, it could be its own little book. Is there anything else you wanted to share or touch on before we get to our very exciting lightning round?
Ada Chen Rekhi :
...
**Yeah, I've learned how to do that better. I have all these auto templates of ways to say no in different ways. Actually, ChatGPT, somebody's tweeted this that it has all kinds of good suggestions. If you could ask it, how do I say no to my manager who wants me to prioritize a feature? And has all kinds of clever words to [inaudible 00**:
