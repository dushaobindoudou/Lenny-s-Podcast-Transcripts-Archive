# Jake Knapp + John Zeratsky - Lenny's Podcast Insights
## Jake Knapp + John Zeratsky - Lenny's播客洞见

---

## About the Guest | 关于嘉宾

**Jake Knapp + John Zeratsky** joined Lenny for an in-depth conversation on product management, leadership, and building successful products.

**Jake Knapp + John Zeratsky** 与Lenny进行了深入对话，讨论产品管理、领导力和打造成功产品的经验。

---

## Key Takeaways | 核心要点

### Amazing. Let's look at an example. That's a really good idea. I know you brought some examples. You're going to do some screen sharing. You're going to pull it up. If you're watching on YouTube, you'll be able to see it. Also, if you're watching on Spotify, you can see the video. If you're on Apple [inaudible 00

17:11]. But do your best to describe what we're going to be looking at.
Jake Knapp :
...
### Yeah, yeah. It probably should be. It probably should be [inaudible 00
...
In honor of.
Jake Knapp :
Yeah, so here it is. And you can see that Marie is more likely to swe...

### Awesome. I love that lens. I love that you asterisk out so it's not a little bit [inaudible 00
...
:
They're going to test these prototypes head-to-head, and also show people like, okay, here's Etsy,...
...
Jake Knapp :
We see this again and again. I can share a couple of other boards of ones ...

### Yeah. Okay. Let's jump in here and take a look at a company again, in our current group of labs teams, Axion Orbital it's called. The founder, [inaudible 01

29:30], is actually running this whole process solo, which is pretty cool too. He's a remarkable guy. We have a couple of solo founders right now who are able to generate ...
:
...
:
To ground us in this story, his founding hypothesis is he wants to help geospatial devs solve these sort of complex workflows with a browser...

### In the first week ... I can show you this prototype right here, and it's a marketing page. On this marketing page, there's a link to a video. If I click find out more, I'm going to see this video. This video is going to kind of hear [inaudible 01

30:27] talking over it. It's going to kind of walk through a screen share of a very rudimentary version of what this product might look like.
:
...
:
He was focusing in that first sprint on the messaging, on finding those people who actually have that role, testing it with them, and he lea...

### Now, one thing that's cool here, we saw the big leap with Latchet from one week to another in terms of their learnings and the scorecards. One of the things that's interesting here is to go from [inaudible 01

31:19]'s first prototype here to his second prototype.
:
...
:
An important thing that he's done here with this is he's built out a lot and created a video of something so that the product, while not fully functional, you can see exactly how it works. If we sort of play this vi...

### Yeah, I think it's kind of interesting to see the sketches that went into [inaudible 01

35:40]'s prototype, the Axion Orbital prototype that we just looked at, because they are super detailed.
:
...
:
If you end up vibe coding this prototype, but you start off with a very clear plan about this is what the thing needs...
...
### You can find me on LinkedIn. John [inaudible 01

40:51] find you on LinkedIn, too.
John Zeratsky :
Yeah.
Lenny Rachitsky :
