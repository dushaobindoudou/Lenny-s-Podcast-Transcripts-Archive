# Alexander Embiricos - Lenny's Podcast Insights
## Alexander Embiricos - Lenny's播客洞见

---

## ## 关于嘉宾 | About the Guest

**Alexander Embiricos** 与Lenny进行了关于产品管理、领导力和打造成功产品的深入对话。

**Alexander Embiricos** 与Lenny进行了深入对话，讨论产品管理、领导力和打造成功产品的经验。

---

## ## 核心要点 | Key Takeaways

### I love how much we're learning about your personality hearing these recommendations. Nice protagonists, optimistic futures. I like the [inaudible 01
...
Alexander Embiricos :
Yeah, so I have been quite into combustion engines and cars. Actually, the reason I came to America initially was because I wanted to work on US aircraft, but ...
...
**I'm one of those people who has social media only for the purposes of having work. My phone turns black and white at 9**:

00 PM at night. But yeah, so Twitter or X, @Embirico. And yeah, if you post in r/Codex, I'll probably see it. So you can go there.
:
