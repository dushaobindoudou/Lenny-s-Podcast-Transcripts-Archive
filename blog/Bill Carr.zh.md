# Bill Carr - Lenny's Podcast Insights
## Bill Carr - Lenny's播客洞见

---

## ## 关于嘉宾 | About the Guest

**Bill Carr** 与Lenny进行了关于产品管理、领导力和打造成功产品的深入对话。

**Bill Carr** 与Lenny进行了深入对话，讨论产品管理、领导力和打造成功产品的经验。

---

## ## 核心要点 | Key Takeaways

### So, yes, the point was, again, it's this other article... So we took it as an article of faith that if we can just improve these inputs, the outputs will take care of themselves. The inputs are the things that drive the outputs, which are revenue, customer activity, free cashflow. And so one of Amazon's... It's not really a secret, but one of Amazon's great strengths is [inaudible 01

00:28] focus on those things and make just continuous process, continuous improvement on each one of them and measure them rigorously.
Lenny :
The flywheel, you reminded me. It feels like that's another concept Amazon proliferated through all of companies is everyone's trying to create their own little flywheel, and I imagine everyone has that image of the Amazon flywheel in their head with a little orange circle in the center and the black arrows. On the topic of input metrics, just briefly, wh...
...
**So I don't know if you saw this, but I asked on Twitter what questions I should ask you and tell people you were coming on. And something that came up a bunch is with working backwards, obviously some products Amazon has launched have not worked out. Say the Fire Phone is a classic example. What have you learned from that process of just like, "Okay. [inaudible 01**:

04:42] won't work out"? Also knowing many things are not going to work out, there's no way to really [inaudible 01:04:46].
Bill Carr :
