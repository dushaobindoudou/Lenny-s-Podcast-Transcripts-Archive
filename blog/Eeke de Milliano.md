# Eeke de Milliano - Lenny's Podcast Insights
## Eeke de Milliano - Lenny's播客洞见

---

## About the Guest | 关于嘉宾

**Eeke de Milliano** joined Lenny for an in-depth conversation on product management, leadership, and building successful products.

**Eeke de Milliano** 与Lenny进行了深入对话，讨论产品管理、领导力和打造成功产品的经验。
...
Instructions on Writing and Life by Anne Lamott. It's incredible. So touching. Really, really great. Also, I think product managers should be great writers. So, I love that.
Eeke de Milliano :
And then the other book that I was going to say, but I'm glad you mentioned Claire, is Claire's book, Scaling People, which is coming out. I had a very small hand in ghost writing for her a little bit, in the first draft. So I use a lot of the early chapters from that book still, in management. And I still...
...
**So we built... Essentially, we spin up a post [inaudible 00**:

33:32] database for you. And you can just access it via a really nice UI and manage it directly in Retool.
Lenny :
