# Madhavan Ramanujam - Lenny's Podcast Insights
## Madhavan Ramanujam - Lenny's播客洞见

---

## About the Guest | 关于嘉宾

**Madhavan Ramanujam** joined Lenny for an in-depth conversation on product management, leadership, and building successful products.

**Madhavan Ramanujam** 与Lenny进行了深入对话，讨论产品管理、领导力和打造成功产品的经验。

---

## Key Takeaways | 核心要点

### Fin, actually, they're a new sponsor of the podcast, and I learned... I didn't know this. It costs 99 cents for every support ticket they solve [inaudible 00
...
Lenny Rachitsky :
And interestingly, they were the most hated pricing model initially...
...
**So if I have to boil down the core thesis of the book, it is basically that if you want to build an enduring business, you need to be able to architect towards profitable growth. What that means is you need to be able to master two engines**:
...
**I think it should be [inaudible 01**:
