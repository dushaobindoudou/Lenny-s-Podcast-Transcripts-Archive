# Lauren Ipsen - Lenny's Podcast Insights
## Lauren Ipsen - Lenny's播客洞见

---

## ## 关于嘉宾 | About the Guest

**Lauren Ipsen** 与Lenny进行了关于产品管理、领导力和打造成功产品的深入对话。

**Lauren Ipsen** 与Lenny进行了深入对话，讨论产品管理、领导力和打造成功产品的经验。

---

## ## 核心要点 | Key Takeaways

### I want to talk about what recruiters often do wrong and what you've learned there. But before we get there, one last question

do you have any tips for a product manager in the interviewing process, how to be more successful interviewing?
Lauren Ipsen :
I've had this come up a few times when I've interviewed product folks that they'll speak down on their counterparts or say that the reason they weren't able to meet deadlines or push product in the right way was because of the engineering team or because of other components of the business and it wasn't them. And so I think that's never a good way to go about it. So it s...
